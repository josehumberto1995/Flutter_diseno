    ...
    return Theme(
      ...
      child: BottomNavigationBar(
        ...
        items:[
          ...
          icon: Icon(Icons.calendar_today, size: 30.00),
          title: Container(),
        ),
         BottomNavigationBarItem(
          icon: Icon(Icons.bubble_chart, size: 30.00),
          title: Container(),
        ),
         BottomNavigationBarItem(
          icon: Icon(Icons.supervised_user_circle, size: 30.00),
          title: Container(),
        ),
       ]
      ),
  ...
  Widget _botonesRedondeados() {
    return Table(
      children: [
        ...
        TableRow(
          children: [
          _crearBotonRedondeado(Colors.blueAccent, Icons.movie_filter, 'Enternaiment'),
          _crearBotonRedondeado(Colors.green, Icons.cloud, 'Gocery'),
          ]
        ),
        TableRow(
          children: [
